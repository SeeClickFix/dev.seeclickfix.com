...
At various endpoints SeeClickFix recognizes geography inputs in various formats.
...
Area attributes can be defined in the following forms:

1. `place=:url_name` - See <a href="/v2/places">the places documentation</a> for more information.
