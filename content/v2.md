...
Please provide the following information if at all possible when contacting support:

* the HTTP request including the URL and any parameters
* the HTTP response code and any response payload
* the time of day the request was being made

These details will help us locate matching records in our logs and investigate and resolve issues quickly.
