...
Many API methods take optional parameters. Optional parameters will be identified in the documentation.
...
TODO: Github requests that params be a json string. Do we want a json string or regular post params format?
...
2. Sending the wrong type of JSON values will result in a `400 Bad
   Request` response. TODO: do we need this?
